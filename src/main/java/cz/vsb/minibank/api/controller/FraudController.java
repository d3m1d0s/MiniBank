...
import cz.vsb.minibank.api.dto.common.*;
import cz.vsb.minibank.api.dto.fraud.*;
...
import static cz.vsb.minibank.api.web.AuthHelpers.requireRole;
import cz.vsb.minibank.domain.customer.UserRole;
import cz.vsb.minibank.api.web.AuthHelpers;
...
public class FraudController {
    ...
    private static AlertNoteDto mapNote(cz.vsb.minibank.domain.fraud.FraudAlertNote note) {
     ...
     * {@link cz.vsb.minibank.domain.transfer.DispatchState} sets out, so it is not the opposite reading of
     * a present value.
     */
